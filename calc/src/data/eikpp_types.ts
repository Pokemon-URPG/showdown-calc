...
const GSC: TypeChart = extend(true, {}, RBY, {
  '???': {Dark: 1, Steel: 1},
  Normal: {Dark: 1, Steel: 1},
  Grass: {Dark: 0.5, Steel: 1},
  Fire: {Dark: 1, Steel: 1},
  Water: {Dark: 2, Steel: 1},
  Electric: {Dark: 1, Steel: 1},
  Ice: {Dark: 1, Steel: 1},
  Flying: {Dark: 1, Steel: 0},
  Bug: {Dark: 0.5, Steel: 2},
  Poison: {Dark: 0.5, Steel: 0},
  Ground: {Dark: 1, Steel: 1},
  Rock: {Dark: 1, Steel: 1},
  Fighting: {Dark: 1, Steel: 0},
  Psychic: {Dark: 1, Steel: 1},
  Ghost: {Dark: 2, Steel: 1},
  Dragon: {Dark: 2, Steel: 1},
  Dark: {
    '???': 1,
    Normal: 2,
    Grass: 1,
